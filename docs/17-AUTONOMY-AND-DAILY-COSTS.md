...
- **Image:** `design_generation` → one flashy Gemini design with imagery + slogan locked together (`design-prompt-v7-flash-merch` at 2K). SVG is placeholder only when AI is unavailable.
