...
- **Image:** `design_generation` → one viral Gemini design with imagery + slogan text integrated (`design-prompt-v6-viral-integrated` at 2K). SVG is placeholder only when AI is unavailable.
